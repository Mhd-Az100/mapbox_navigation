...
import 'package:mapbox_navigation/rate_ride.dart';
...
class _TurnByTurnState extends State<TurnByTurn> {
  ...
  //33.513955806825116, 36.27653013833866 (source)
  //33.484406576263325, 36.207631365546604 (destination)
  ...
  Future<void> initialize() async {
    ...
    sourceWaypoint = WayPoint(
        name: "Source",
        latitude: 33.513955806825116,
        longitude: 36.27653013833866);
    destinationWaypoint = WayPoint(
        name: "Destination",
        latitude: 33.484406576263325,
        longitude: 36.207631365546604);
